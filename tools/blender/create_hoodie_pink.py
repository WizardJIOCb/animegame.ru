...
def build_short_sleeve(armature, material, side):
    ...
    return make_skinned_mesh(
        f"hoodie_pink_short_sleeve_{side}",
        verts,
        faces,
        material,
        armature,
...
def create_hoodie():
    ...
    build_short_sleeve(armature, fabric, "l")
    build_short_sleeve(armature, fabric, "r")
